...
<div class="table-responsive">
	<table class="table">
		<tr>
			...
			<th class="text-right"><a href="tiki-directory_ranking.php?parent={$parent}&amp;offset={$offset}&amp;sort_mode={if $sort_mode eq 'hits_desc'}hits_asc{else}hits_desc{/if}">{tr}Hits{/tr}</a></th>
		</tr>
