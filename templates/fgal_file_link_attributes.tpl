{strip}
	...
	{else}
		{if !empty($filegals_manager)}
			href="#" onclick="window.opener.insertAt('{$filegals_manager}',processFgalSyntax('{$file|json_encode|replace:'"':'&quot;'}'), false, false, true);checkClose();return false;" title="{tr}Click here to use the file{/tr}"
