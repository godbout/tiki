...
{/if}
	...
	<div class="row row-middle" id="row-middle">
		...
		{else}
			...
			{/if}
			<div class="col col1 col-md-8 order-xs-1 order-md-2" id="col1">
				{if $prefs.module_zones_pagetop eq 'fixed' or ($prefs.module_zones_pagetop ne 'n' && ! zone_is_empty('pagetop'))}
					{modulelist zone=pagetop}
				{/if}
				{feedback}
			...
			<div class="col col2 col-lg-2 col-md-6 order-xs-2 order-sm-2" id="col2">
				{modulelist zone=left}
			</div>
			<div class="col col3 col-lg-2 col-md-6 order-xs-3" id="col3">
				{modulelist zone=right}
			</div>
		{/if}
	</div>
