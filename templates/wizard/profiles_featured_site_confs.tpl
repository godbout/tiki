		...
		<h3>{tr}Profiles:{/tr}</h3>
			...
			<div class="row">
				<div class="col-md-6">
					...
					(<a href="tiki-admin.php?ticket={ticket mode=get}&profile=Personal_Blog_and_Profile_12x&show_details_for=Personal_Blog_and_Profile_12x&categories%5B%5D={$tikiMajorVersion}.x&categories%5B%5D=Featured+profiles&repository=http%3a%2f%2fprofiles.tiki.org%2fprofiles&page=profiles&preloadlist=y&list=List#step2" target="_blank">{tr}apply profile now{/tr}</a>)
					<br>
					<p>
