            ...
            {if count($composer_packages_available)}
                <tr>
                    <td colspan="5">
                        ...
                        {tr}In the list above there are some optional packages that you might want to install if you what to use the Tiki Wiki features that require that package{/tr}
                        ...
                        <p>
                            ...
                            {tr}You can optionally use teh sample <code>composer.json.dist</code> that comes with Tiki as a starting point.{/tr}
                            {tr}Bellow is a example how to do this in a linux like operating system{/tr}: <br />
