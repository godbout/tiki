...
<p>PHP file check: <?php
    ...
    checkmyfile_exists($filename); ?></p>
<p>PHP read check: <?php
    checkmyfile_readable($filename); ?></p>
...
<p>PHP file check: <?php
    checkmyfile_exists($filename); ?> (should exist now)</p>
<p>PHP read check: <?php
    checkmyfile_readable($filename); ?> (should be readable now)</p>
<p>PHP delete check: <?php
    unlink($filename) or die('cannot delete testfile - ERROR');
    echo 'testfile deleted'; ?> (should be deleted)</p>
<p>PHP file check: <?php
    checkmyfile_exists($filename); ?> (should not exist now)</p>
<p>PHP read check: <?php
    checkmyfile_readable($filename); ?> (should not be readable now)</p>
	<?php
}
?>
