...
class TaskLib extends TikiLib
{
    ...
    * @param null|mixed $find
    * @param mixed $sort_mode
    * @param mixed $show_private
    * @param mixed $show_submitted
    * @param mixed $show_received
    * @param mixed $show_shared
    * @param mixed $use_show_shared_for_group
    * @param null|mixed $show_shared_for_group
    * @param mixed $show_trash
    * @param mixed $show_completed
    * @param mixed $use_admin_mode
    **/
    public function list_tasks(
        ...
        $maxRecords = -1,
        $find = null,
        $sort_mode = 'priority_asc',
        $show_private = true,
        $show_submitted = true,
        $show_received = true,
        $show_shared = true,
        $use_show_shared_for_group = false,
        $show_shared_for_group = null,
        $show_trash = false,
