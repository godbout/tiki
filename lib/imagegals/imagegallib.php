...
class ImageGalsLib extends TikiLib
{
     ...
     * @return int
     */
    public function max_img_upload_size()
    {
        global $tikilib;
     ...
     * @return bool
     */
    public function readimagefromstring()
    {
        if (! isset($this->image)) {
            return false;
        }
    ...
    public function writeimagetostring()
    {
        if ($this->uselib == "imagick") {
     ...
     * @return bool
     */
    public function readimagefromfile($fname)
    {
        @$fp = fopen($fname, "rb");
     ...
     * @param $fname
     */
    public function pipeimage($fname)
    {
        $fp = fopen($fname, "rb");
    ...
    public function repairimageinfo()
    {
     ...
     * @param $fname
     */
    public function getfileinfo($fname)
    {
     ...
     * @return bool
     */
    public function resizeImage($newx, $newy)
    {
        if (! isset($this->imagehandle)) {
            $this->readimagefromstring();
        }
     ...
     * @return bool
     */
    public function rescaleImage($bbx, $bby)
    {
        if (! $bbx || ! $bby) {
            return true;
        }
     ...
     * @return bool
     */
    public function issupported($imagetype)
    {
        if ($this->uselib == "imagick") {
     ...
     * @return bool|int
     */
    public function process_batch_image_upload($galleryId, $file, $user)
    {
        global $prefs;
     ...
     * @return bool
     */
    public function add_image_hit($id)
    {
        global $prefs, $user;
     ...
     * @return bool
     */
    public function add_gallery_hit($id)
    {
        global $prefs, $user;
     ...
     * @return bool
     */
    public function store_image_data($overwrite = false)
    {
        global $prefs;
     ...
     * @return bool
     */
    public function rebuild_image($imageid, $itype, $xsize, $ysize = 0)
    {
        global $prefs;
     ...
     * @return bool
     */
    public function rebuild_thumbnails($galleryId)
    {
        global $prefs;
     ...
     * @param $imageId
     */
    public function rebuild_scales($galleryId, $imageId = -1)
    {
     ...
     * @return bool
     */
    public function edit_image($id, $name, $description, $lat = null, $lon = null, $file = null)
    {
        global $prefs;
     ...
     * @return bool
     */
    public function insert_image($galleryId, $name, $description, $filename, $filetype, &$data, $size, $xsize, $ysize, $user, $t_data, $t_type, $lat = null, $lon = null, $gal_info = null)
    {
        global $prefs;
     ...
     * @param $user
     */
    public function notify($imageId, $galleryId, $name, $filename, $description, $galleryName, $action, $user)
    {
        global $prefs;
     ...
     * @param $angle
     */
    public function rotate_image($id, $angle)
    {
        //get image
        global $prefs;
     ...
     * @param $id
     */
    public function rotate_right_image($id)
    {
     ...
     * @param $id
     */
    public function rotate_left_image($id)
    {
     ...
     * @return bool
     */
    public function remove_image($id, $user)
    {
        global $prefs;
     ...
     * @return array
     */
    public function get_images($offset, $maxRecords, $sort_mode, $find, $galleryId = -1)
    {
        if ($find) {
            $findesc = '%' . $find . '%';
     ...
     * @return array
     */
    public function get_subgalleries($offset, $maxRecords, $sort_mode, $find, $galleryId = -1)
    {
        if ($sort_mode == '') {
            $sort_mode = 'name_asc';
     ...
     * @return mixed
     */
    public function get_gallery_image($galleryId, $rule = '', $sort_mode = '')
    {
     ...
     * @return array
     */
    public function get_prev_and_next_image($sort_mode, $find, $imageId, $galleryId = -1)
    {
        if ($find) {
            $findesc = '%' . $find . '%';
     ...
     * @return mixed
     */
    public function get_first_image($sort_mode, $find, $galleryId = -1)
    {
        if ($find) {
            $findesc = '%' . $find . '%';
     ...
     * @return mixed
     */
    public function get_last_image($sort_mode, $find, $galleryId = -1)
    {
     ...
     * @return array
     */
    public function list_images($offset, $maxRecords, $sort_mode, $find, $galleryId = -1)
    {
     ...
     * @return array
     */
    public function get_random_image($galleryId = -1)
    {
        $whgal = "";
        $bindvars = [];
        if (((int)$galleryId) != -1) {
     ...
     * @return array
     */
    public function list_visible_galleries($offset = 0, $maxRecords = -1, $sort_mode = 'name_desc', $user, $find)
    {
     ...
     * @return mixed
     */
    public function get_gallery_owner($galleryId)
    {
        $query = "select `user` from `tiki_galleries` where `galleryId`=?";
     ...
     * @return mixed
     */
    public function get_gallery_from_image($imageid)
    {
     ...
     * @return bool
     */
    public function move_image($imgId, $galId)
    {
     ...
     * @return mixed
     */
    public function get_image_info($id, $itype = 'o', $xsize = 0, $ysize = 0)
    {
     ...
     * @return mixed
     */
    public function get_image($id, $itype = 'o', $xsize = 0, $ysize = 0)
    {
        global $prefs;
     ...
     * @return bool
     */
    public function get_etag($id, $itype = 'o', $xsize = 0, $ysize = 0)
    {
     ...
     * @return mixed
     */
    public function get_imageid_byname($name, $galleryId = 0)
    {
        $bindvars = [$name];
     ...
     * @return mixed
     */
    public function get_image_thumb($id)
    {
     ...
     * @param $scale
     */
    public function add_gallery_scale($galleryId, $scale)
    {
     ...
     * @param int $scale
     */
    public function remove_gallery_scale($galleryId, $scale = 0)
    {
        $mid = "";
        $bindvars = [(int) $galleryId];
        if ($scale != 0) {
     ...
     * @return mixed
     */
    public function get_gallery_info($id)
    {
     ...
     * @return array
     */
    public function get_gallery_scale_info($id)
    {
     ...
     * @return mixed
     */
    public function get_gallery_next_scale($id, $scale = 0)
    {
        $query = "select * from `tiki_galleries_scales` where `galleryId`=?
     ...
     * @return mixed
     */
    public function get_gallery_default_scale($id)
    {
     ...
     * @return array
     */
    public function get_gallery_prevnext_scale($id, $currentscale)
    {
        $ret = [];
     ...
     * @return mixed
     */
    public function capture_images($data)
    {
     ...
     * @return array
     */
    public function get_one_image_from_disk($userfile, $galleryId = 0, $name = '', $description = '', $gal_info = '')
    {
        global $prefs, $user;
        $ret = [];
     ...
     * @return bool|int
     */
    public function move_image_store($imageId, $direction = 'to_fs')
    {
        global $prefs;
     ...
     * @return array|bool
     */
    public function move_gallery_store($galId, $direction = 'to_fs')
    {
    ...
    public function clear_class_vars()
    {
     ...
     */
    public function ratio($xsize, $ysize, $xbox = 0, $ybox = 0)
    {
