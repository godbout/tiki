...
//	The Iframe Transport is required for browsers without support for XHR file uploads
	$headerlib->add_jsfile('vendor/npm-asset/blueimp-file-upload/js/jquery.iframe-transport.js');
//	The basic File Upload plugin
	$headerlib->add_jsfile('vendor/npm-asset/blueimp-file-upload/js/jquery.fileupload.js');
