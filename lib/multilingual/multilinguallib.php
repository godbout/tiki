...
class MultilingualLib extends TikiLib
{
     ...
     * @param null|mixed $include_browser_lang
     */
     ...
     * @param mixed $type
     * @param mixed $listObjs
     * @param null|mixed $langContext
     */
     ...
     * examples of use.
     * @param mixed $src_lang
     * @param mixed $langs_already_translated
     * @param mixed $user_langs
     */
