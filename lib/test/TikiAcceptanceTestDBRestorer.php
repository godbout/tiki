 ...
 */
{
    ...
    abstract public function create_dump_file($dump_file);

    public function set_mysql_data_dir()
    {
    ...
    abstract public function check_if_dump_exists($dump_file);
    ...
    public function reinitialize_internal_values_and_clear_caches()
    {
        global $prefs;
...
class TikiAcceptanceTestDBRestorerSQLDumps extends TikiAcceptanceTestDBRestorer
{
    ...
    public function check_if_dump_and_schema_start_files_exist($dump_file)
    {
    ...
    public function check_if_dump_exists($dump_file)
    {
    ...
    //This method can be called to create any dump file from a db.
    //Useful for creating dumps for diffent test db configurations
    public function create_dump_file($dump_file)
    {
        chdir($this->mysql_data_dir);
    ...
    public function create_start_schema_files()
    {
        chdir($this->mysql_data_dir);
    ...
    public function create_testdb_dump_and_start_schema_files()
    {
    ...
    public function get_table_name(&$table_name_date_time)
    {
...
class TikiAcceptanceTestDBRestorerBinaryDumps extends TikiAcceptanceTestDBRestorer
{
    ...
    public function create_dump_file($dump_name)
    {
