...
(function($) {
	...
	$('.table-responsive:not(.article-types):not(.comment-table)').each(function () {
		// mobile friendly tables
		if ($(this).find('table tbody tr').width() - 5 > $(this).width()) {
			if (!$(this).hasClass('large-table')) $(this).addClass('large-table');
		}
		// action column
