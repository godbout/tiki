...
function ajaxSubmitEventHandler(successCallback, dataType) {
	return function (e) {
		...
		// if the encryption type on the form is set to 'multipart/form-data' or 'application/x-www-form-urlencoded',
		// we must set contentType and processData to false on the ajax submission
		// to prevent jQuery from attempting to turn file fields into a string

		if (form.enctype === "multipart/form-data" || form.enctype === "application/x-www-form-urlencoded") {
