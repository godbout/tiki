...
/**
 * Utility used in previous method so that the security timeout warning is only shown the first time a form element
 * is clicked. This is so that any contents in the input element can be copied if needed before losing the data.
 * See also checkTimeout() method below.
 *
 * @param element
 * @returns {boolean}
 */
