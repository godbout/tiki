...
(function ($) {
					...
					sendData = {
						...
						complete: function (data, textStatus) {
							...
							if (data.responseJSON) {
								...
								// for modal
								$('form.file-uploader-result input[name=ticket]')
									.val(ticket);
	...
	$(document).on('change', '.file-uploader input[type=file]', function () {
		...
		if (this.files) {
			...
			if ($inlineDiv.length) {
				$form.data("galleryId", $inlineDiv.data("galleryId"))
				$form.data("ticket", $inlineDiv.data("ticket"))
				$form.data("image_max_size_x", $inlineDiv.data("image_max_size_x"))
				$form.data("image_max_size_y", $inlineDiv.data("image_max_size_y"))
			}
