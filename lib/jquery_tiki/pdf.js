...
function storeSortTable(tableName,tableHTML){
	...
	$('.icon-pdf').parent().bind( "click", function() {
		//show spinner
		$('.wikiinfo').html('<div class="alert alert-info   highlight" style="width:500px"><h4><span class="icon icon-information fas fa-info-circle fa-fw "></span>&nbsp;<span class="rboxtitle">Please wait</span></h4><div class="rboxcontent" style="display: inline"><span class="fas fa-circle-notch fa-spin" style="font-size:24px"></span>  Your PDF is getting ready, please wait.. </div></div>');
		$('.wikiinfo').show();
