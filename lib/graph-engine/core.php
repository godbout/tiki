...
class GRenderer // {{{1
{
    ...
    public function _getRawColor($name) // {{{2
    {
        switch ($name) {
            case 'red':
...
class Graphic // {{{1
{
    ...
    public function addLegend($color, $value, $url = null) // {{{2
    {
        // $color name
        // $value label
    ...
    public function addDataHandler($handler) // {{{2
    {
    ...
    public function draw(&$renderer) // {{{2
    {
        $top = 0;
        $left = 0;
        $bottom = 1;
    ...
    public function setData($data) // {{{2
    {
        if (! is_array($data)) {
            return false;
        }
    ...
    public function setParam($name, $value) // {{{2
    {
        $this->parameters[$name] = $value;
    }

    public function _getColor() // {{{2
    {
        static $index = 0;
        $colors = [
            'Red',
    ...
    public function _drawLegend(&$renderer, &$left, &$top, &$right, &$bottom, $layout) // {{{2
    {
