...
class OOoTable extends absOOo
{
    ...
    public function run(&$nodeContent, &$nodeStyle, $dir)
    {
        ...
        if (isset($this->_style["width"])) {
            $propertiesNode->setAttribute("style:width", $this->_style["width"] . "cm");
        }
        if (isset($this->_style["align"])) {
            $propertiesNode->setAttribute("table:align", $this->_style["align"]);
        }

        if (isset($this->_style["marginL"])) {
            $propertiesNode->setAttribute("fo:margin-left", $this->_style["marginL"] . "cm");
        }
        if (isset($this->_style["marginR"])) {
            $propertiesNode->setAttribute("fo:margin-right", $this->_style["marginR"] . "cm");
        }
        if (isset($this->_style["marginT"])) {
            $propertiesNode->setAttribute("fo:margin-top", $this->_style["marginT"] . "cm");
        }
        if (isset($this->_style["marginB"])) {
            $propertiesNode->setAttribute("fo:margin-bottom", $this->_style["marginB"] . "cm");
        }
        ...
        if (isset($this->_style["img"]) && isset($this->_style["img"]["src"])) {
            ...
            if (isset($this->_style["img"]["type"])) {
                $backgroundImageNode->setAttribute("style:repeat", $this->_style["img"]["type"]);
            }
            if (isset($this->_style["img"]["position"])) {
                $backgroundImageNode->setAttribute("style:position", $this->_style["img"]["position"]);
            }
        ...
        for ($i = 0; $i < $this->_row; $i++) {
            ...
            for ($j = 0; $j < $this->_column; $j++) {
                ...
                if (isset($this -> _style["widthRow"][$j]) && $i === 0) {
                    ...
                    $propertiesNode = & $this->xml->createElement("style:properties");
                    if (isset($this -> _style["widthRow"])) {
                        $propertiesNode->setAttribute("style:column-width", $this -> _style["widthRow"][$j] . "cm");
                    }
                    $styleNode->appendChild($propertiesNode);
                    $nodeStyle->appendChild($styleNode);
                ...
                $propertiesNode = & $this->xml->createElement("style:properties");
                if (isset($this->_ligne[$i][$j]["padding"])) {
                    $propertiesNode->setAttribute("fo:padding", $this->_ligne[$i][$j]["padding"] . "cm");
                }
                if (isset($this->_ligne[$i][$j]["vAlign"])) {
                    $propertiesNode->setAttribute("fo:vertical-align", $this->_ligne[$i][$j]["vAlign"]);
                }
                if (isset($this->_ligne[$i][$j]["bgColor"])) {
                    $propertiesNode->setAttribute("fo:background-color", $this->_ligne[$i][$j]["bgColor"]);
                }

                if (isset($this->_style["borderL"])) {
                    $propertiesNode->setAttribute("fo:border-left", $this->_style["borderL"]);
                }
                if (isset($this->_style["borderR"])) {
                    $propertiesNode->setAttribute("fo:border-right", $this->_style["borderR"]);
                }
                if (isset($this->_style["borderT"])) {
                    $propertiesNode->setAttribute("fo:border-top", $this->_style["borderT"]);
                }
                if (isset($this->_style["borderB"])) {
                    $propertiesNode->setAttribute("fo:border-bottom", $this->_style["borderB"]);
                }
                if (isset($this->_ligne[$i][$j]["borderL"])) {
                    $propertiesNode->setAttribute("fo:border-left", $this->_ligne[$i][$j]["borderL"]);
                }
                if (isset($this->_ligne[$i][$j]["borderR"])) {
                    $propertiesNode->setAttribute("fo:border-right", $this->_ligne[$i][$j]["borderR"]);
                }
                if (isset($this->_ligne[$i][$j]["borderT"])) {
                    $propertiesNode->setAttribute("fo:border-top", $this->_ligne[$i][$j]["borderT"]);
                }
                if (isset($this->_ligne[$i][$j]["borderB"])) {
                    $propertiesNode->setAttribute("fo:border-bottom", $this->_ligne[$i][$j]["borderB"]);
                }
                ...
                if (isset($this->_ligne[$i][$j]["img"]) && isset($this->_ligne[$i][$j]["img"]["src"])) {
                    ...
                    $backgroundImageNode->setAttribute("xlink:type", "simple");
                    $backgroundImageNode->setAttribute("xlink:actuate", "onLoad");
                    if (isset($this->_ligne[$i][$j]["img"]["type"])) {
                        $backgroundImageNode->setAttribute("style:repeat", $this->_ligne[$i][$j]["img"]["type"]);
                    }
                    if (isset($this->_ligne[$i][$j]["img"]["position"])) {
                        $backgroundImageNode->setAttribute("style:position", $this->_ligne[$i][$j]["img"]["position"]);
                    }
            ...
            if ($i === 0) {
                $tableNode->appendChild($tableHeaderRowsNode);
            } else {
