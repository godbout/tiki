        ...
        for ($i = 0; $i < count($this->_text); $i++) {
            if (!is_object($this->_text)) {
                if ($i == 0) {
                    ...
                    if (isset($this->_text[$i]["NameStyle"]) && !isset($this->_style)) {
                        $pNode->setAttribute("text:style-name", $this->_text[$i]["NameStyle"]);
                    } else {
                ...
                if (isset($this->_text[$i]["styleCarac"])) {
                    ...
                    if ($this->_text[$i]["lineBreak"]) {
                        $spanNode->appendChild($this->xml->createElement("text:line-break"));
                    }
                    if ($this->_text[$i]["tabStop"]) {
                        $spanNode->appendChild($this->xml->createElement("text:tab-stop"));
                    }
                    ...
                    if ($this->_text[$i]["lineBreak"]) {
                        $pNode->appendChild($this->xml->createElement("text:line-break"));
                    }
                    if ($this->_text[$i]["tabStop"]) {
                        $spanNode->appendChild($this->xml->createElement("text:tab-stop"));
                    }
