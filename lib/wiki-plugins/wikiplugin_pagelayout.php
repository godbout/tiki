...
function wikiplugin_pagelayout($data, $params)
{
    ...
    if(isset($params['pageContentWidth']) || isset($params['pageContentPadding'])) {
    	$headerlib->add_css("#row-middle{width:".$params["pageContentWidth"].";margin:auto;padding-top:".$params['pageContentPadding']."}");
    }
    ...
    if(isset($params['fgallId'])) {
        ...
        $headerlib->add_css('.bgdiv{ 
            ...
            background-color:'.$params["pageBackgroundColor"].'
    ...
    if(isset($params['contentBg'])) {
        $headerlib->add_css("#row-middle{background-color:".$params["contentBg"]."}");
    }
