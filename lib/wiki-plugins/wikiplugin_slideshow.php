...
function wikiplugin_slideshow($data, $params)
{
    ...
    $revealParams = ['parallaxBackgroundImage', 'parallaxBackgroundSize', 'parallaxBackgroundHorizontal', 'parallaxBackgroundVertical', 'slideSeconds', 'transition', 'transitionSpeed', 'backgroundTransition', 'controls', 'controlsLayout', 'controlsBackArrows', 'progress', 'slideNumber', 'autoSlide', 'autoSlideStoppable'];
    $revealSettings = '';
    ...
    $revealSettings = str_replace(["'y'", "'n'"], ["true", "false"], $revealSettings);
