...
class Tracker_Query
{
     ...
     *
     * @param mixed $trackerPrimary
     * @param mixed $nameOrder
     */
    ...
    public function arfsort_func($a, $b)
    {
     ...
     * @param   string  $value
     * @param mixed $tracker
     * @param mixed $fieldIdsToRemove
     * @param mixed $fieldIdsToShow
     * @return  mixed $value rendered field value
     */
     ...
     *
     * @param mixed $trackerLeft
     * @param mixed $trackerRight
     * @param mixed $fieldLeftId
