...
class SearchLib extends TikiLib
{
    ...
    **/
     ...
     * @return array
     */
    public function find_galleries($words = '', $offset = 0, $maxRecords = -1, $fulltext = false, $filter = '', $boolean = 'n', $searchDate = 0, $categId = 0)
    {
     ...
     * @return array
     */
    public function find_images($words = '', $offset = 0, $maxRecords = -1, $fulltext = false, $filter = '', $boolean = 'n', $searchDate = 0, $categId = 0)
    {
